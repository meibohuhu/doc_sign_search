#!/usr/bin/env python3
"""
Generate JSON for Segmented Training Video Clips with Question Diversity
=========================================================================

This script generates a JSON file similar to segmented_test_videos.json but for training segmented video clips.
...
Usage:
    python generate_segmented_json_train.py [--input-csv CSV_FILE] [--video-dir VIDEO_DIR] [--output-json OUTPUT_FILE] [--seed SEED]
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('generate_segmented_json_train.log'),
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description="Generate JSON for segmented training video clips")
    parser.add_argument("--input-csv", 
                       default="how2sign_realigned_train.csv",
                       help="Path to input CSV file (default: how2sign_realigned_train.csv)")
    parser.add_argument("--video-dir", 
                       default=r"D:\how2sign_train_segment_clips",
                       help="Directory containing segmented videos (default: D:\\how2sign_train_segment_clips)")
    parser.add_argument("--output-json", 
                       default="segmented_train_videos.json",
                       help="Output JSON file (default: segmented_train_videos.json)")
