...
Video Segmentation Script for How2Sign Dataset
==============================================

This script segments videos into clips based on start and end times from a CSV file.
It processes the how2sign_realigned_test.csv file and creates individual video clips
for each sentence/segment.

Usage:
    python segment_videos_test_videos.py [--input-csv CSV_FILE] [--input-dir VIDEO_DIR] [--output-dir OUTPUT_DIR] [--max-clips MAX_CLIPS]
...
class VideoSegmenter:
    ...
    def save_metadata(self, output_file: str = "segmentation_metadata.json"):
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description="Segment videos based on CSV timing data")
    parser.add_argument("--input-csv", 
                       default="how2sign_realigned_test.csv",
                       help="Path to input CSV file (default: how2sign_realigned_test.csv)")
    parser.add_argument("--input-dir", 
                       default="raw_videos",
                       help="Directory containing input videos (default: raw_videos)")
    parser.add_argument("--output-dir", 
                       default="segmented_clips",
                       help="Directory for output clips (default: segmented_clips)")
