#!/usr/bin/env python3
"""
Generate JSON for Segmented Video Clips
======================================

mhu update 09/22/2025
This script generates a JSON file similar to rgb_vid_df_test.json but for segmented video clips.
It matches the segmented videos with their corresponding sentences from the CSV file.

Usage:
    python generate_segmented_json.py [--input-csv CSV_FILE] [--video-dir VIDEO_DIR] [--output-json OUTPUT_FILE]

Author: Generated for LLaVA-NeXT project
Date: 2025
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('generate_segmented_json.log'),
...
class SegmentedJSONGenerator:
    ...
    def _create_json_entry(self, video_file: Path, sentence: str) -> Dict[str, Any]:
        """
        ...
        Returns:
            Dictionary representing the JSON entry
        """
    ...
    def generate_json(self) -> List[Dict[str, Any]]:
        ...
        for video_file in video_files:
            ...
            if video_name in video_to_sentence:
                ...
                entry = self._create_json_entry(video_file, sentence)
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description="Generate JSON for segmented video clips")
    parser.add_argument("--input-csv", 
                       default="how2sign_realigned_test.csv",
                       help="Path to input CSV file (default: how2sign_realigned_test.csv)")
    parser.add_argument("--video-dir", 
                       default="test_new_naming",
                       help="Directory containing segmented videos (default: test_new_naming)")
    parser.add_argument("--output-json", 
                       default="segmented_videos.json",
                       help="Output JSON file (default: segmented_videos.json)")
