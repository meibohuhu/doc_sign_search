#!/usr/bin/env python3
"""
Video Segmentation Script for How2Sign Validation Dataset
==========================================================

This script segments validation videos into clips based on start and end times from a CSV file.
It processes the how2sign_realigned_val.csv file and creates individual video clips
for each sentence/segment.

Usage:
    python segment_videos_val.py [--input-csv CSV_FILE] [--input-dir VIDEO_DIR] [--output-dir OUTPUT_DIR] [--max-clips MAX_CLIPS]
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('video_segmentation_val.log'),
...
class VideoSegmenter:
    ...
    def save_metadata(self, output_file: str = "segmentation_metadata_val.json"):
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description="Segment validation videos based on CSV timing data")
    parser.add_argument("--input-csv", 
                       default=r"how2sign_realigned_val.csv",
                       help="Path to input CSV file (default: how2sign_realigned_val.csv)")
    parser.add_argument("--input-dir", 
                       default=r"D:\val_raw_videos\raw_videos",
