#!/bin/bash -l
# Qwen2VL Checkpoint-4000 Evaluation Script
# Based on qwen25_metrics.py reference approach

#SBATCH --job-name=qwen2vl_eval_checkpoint4000_train
...
CHECKPOINT_PATH="/shared/rc/llm-gen-agent/mhu/qwen2.5vl/1018/qwen2vl_how2sign_4xa100_filtered_32batchsize_robust/checkpoint-4000"
