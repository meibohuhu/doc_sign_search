...
CHECKPOINT_PATH="/shared/rc/llm-gen-agent/mhu/qwen2.5vl/qwen2vl_how2sign_4xa100_filtered_32batchsize_fast/checkpoint-4000"
...
echo "🎬 Qwen2VL Checkpoint-4000 Evaluation"
echo "======================================"
