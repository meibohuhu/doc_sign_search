...
#SBATCH --job-name=qwen2vl_eval_checkpoint6000
...
CHECKPOINT_PATH="/shared/rc/llm-gen-agent/mhu/qwen2.5vl/1018/qwen2vl_how2sign_4xa100_filtered_32batchsize_robust/checkpoint-6000"
