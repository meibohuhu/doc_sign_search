...
# Configuration
MODEL="${MODEL:-gpt-4o}"  # Azure deployment model name
INPUT_FILE="${INPUT_FILE:-/local1/mhu/sign_language_llm/outputs/gpt5_eval/122240/122240_1/gpt4v_results_test.json}"
OUTPUT_FILE="${OUTPUT_FILE:-}"  # Auto-generated if not specified
OUT_DIR="${OUT_DIR:-/local1/mhu/sign_language_llm/outputs/gpt5_eval/122240/122240_1/}"
...
MAX_WORKERS=${MAX_WORKERS:-5}  # Maximum number of worker threads
