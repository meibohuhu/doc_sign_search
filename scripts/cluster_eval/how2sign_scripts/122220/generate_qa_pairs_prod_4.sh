...
INPUT_FILE="${INPUT_FILE:-/code/doc_sign_search/outputs/gpt5_eval/122220/122220_4/gpt4v_results_20251226_103017.json}"
OUTPUT_FILE="${OUTPUT_FILE:-}"  # Auto-generated if not specified
OUT_DIR="${OUT_DIR:-/code/doc_sign_search/outputs/gpt5_eval/122220/122220_4/}"
