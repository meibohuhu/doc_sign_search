...
GPU_IDS=${GPU_IDS:-"2"}  # Change this to "0", "1", etc. to use different physical GPU
...
# Add CUDA device (always use first visible GPU, which is cuda:0 after CUDA_VISIBLE_DEVICES filtering)
EVAL_ARGS+=(--cuda-device "0")
