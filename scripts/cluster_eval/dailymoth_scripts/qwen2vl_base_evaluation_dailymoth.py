#!/usr/bin/env python3
"""
Qwen2.5-VL-3B-Instruct Base Model Evaluation Script for DailyMoth-70h Dataset
...
def eval_model(args):
    ...
    print(f"🎬 Qwen2.5-VL-3B-Instruct BASE Model Evaluation on DailyMoth-70h")
    print("=" * 70)
    ...
    output_file = f"qwen2vl_base_dailymoth_results_{timestamp}.json"
    ...
    if args.enable_evaluation and references and predictions:
        try:
            ...
            # Print results
            print_evaluation_results(eval_results, "Qwen2VL-BASE-DailyMoth")
            
            # Save evaluation metrics
            eval_file = os.path.join(args.out_dir, f"base_evaluation_metrics_{timestamp}.json")
            save_evaluation_results(eval_results, eval_file, "Qwen2VL-BASE-DailyMoth")
...
def main():
    ...
    parser.add_argument("--out-dir", type=str, 
                       default="/home/mh2803/projects/sign_language_llm/outputs/dailymoth_base/",
