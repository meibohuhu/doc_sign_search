...
# Configuration
# CHECKPOINT_PATH="/shared/rc/llm-gen-agent/mhu/qwen2.5vl/qwen2vl_ssvp_4xa100_12fps/checkpoint-5000"
CHECKPOINT_PATH="/home/mh2803/projects/sign_language_llm/qwenvl/Qwen2-VL-Finetune/output/qwen2vl_ssvp_optimized_1xa100/checkpoint-500"
...
if [ ! -d "$CHECKPOINT_PATH" ]; then
    ...
    ls -la /shared/rc/llm-gen-agent/mhu/qwen2.5vl/qwen2vl_ssvp_4xa100_12fps/ | grep checkpoint
    exit 1
fi
...
/home/mh2803/miniconda3/envs/qwenvl/bin/python scripts/cluster_eval/qwen2vl_evaluation_checkpoint5000.py \
