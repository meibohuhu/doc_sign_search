...
# GPU configuration
GPU_IDS=${GPU_IDS:-"4"}  # Default: use GPU 0 and 1
...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/scratch/mh2803/checkpoints/grpo_internvl2_5_how2sign_1b_blackwell_bleu4_rouge_07_03_0314/checkpoint-400}"
...
SFT_CHECKPOINT="${SFT_CHECKPOINT:-/scratch/mh2803/checkpoints/finetune_internvl2_5_how2sign_1b_16fps_1218_121640/checkpoint-2548}"
# MODEL_BASE="${MODEL_BASE:-OpenGVLab/InternVL2_5-1B}"
...
OUT_DIR="${OUT_DIR:-/home/stu2/s15/mh2803/workspace/doc_sign_search/outputs/blackwell/evaluate_internvl2_5_how2sign_1b_bleu4_rouge_07_03_checkpoint400_0314}"
