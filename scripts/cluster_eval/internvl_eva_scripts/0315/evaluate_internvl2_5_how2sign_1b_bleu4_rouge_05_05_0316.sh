...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/scratch/mh2803/checkpoints/grpo_internvl2_5_how2sign_1b_blackwell_bleu4_rouge_05_05_0316/checkpoint-626}"
...
OUT_DIR="${OUT_DIR:-/home/stu2/s15/mh2803/workspace/doc_sign_search/outputs/blackwell/evaluate_internvl2_5_how2sign_1b_bleu4_rouge_05_05_0316}"
