...
# GPU configuration
GPU_IDS=${GPU_IDS:-"6"}  # Default: use GPU 0 and 1
...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/scratch/mh2803/checkpoints/grpo_internvl2_5_how2sign_1b_bleu1_rouge_0314/checkpoint-626}"
...
OUT_DIR="${OUT_DIR:-/home/stu2/s15/mh2803/workspace/doc_sign_search/outputs/blackwell/evaluate_internvl2_5_how2sign_1b_bleu1_rouge_0314}"
