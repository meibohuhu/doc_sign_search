...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/local1/mhu/sign_language_llm/InternVL/checkpoints/finetune_internvl2_5_openasl_16fps_1205_original/checkpoint-4453}"
# CHECKPOINT_PATH="${CHECKPOINT_PATH:-/local1/mhu/sign_language_llm/InternVL/checkpoints/finetune_internvl2_5_how2sign_4b_16fps_1205/checkpoint-3054}"
...
MODEL_BASE="${MODEL_BASE:-OpenGVLab/InternVL2_5-4B}"
