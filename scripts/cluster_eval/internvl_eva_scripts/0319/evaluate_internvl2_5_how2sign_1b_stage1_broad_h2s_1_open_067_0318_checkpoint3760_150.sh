...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/mnt/localssd/checkpoints/finetune_stage1_broad_h2s_1_open_067_0318/checkpoint-3760}"
...
SFT_CHECKPOINT=""  # Not needed - CHECKPOINT_PATH is already the SFT checkpoint (not a GRPO DS checkpoint)
# MODEL_BASE="${MODEL_BASE:-OpenGVLab/InternVL2_5-1B}"
...
MAX_NUM_FRAMES=${MAX_NUM_FRAMES:-150}  # Maximum number of frames (set to 6 to fix at 6 frames)
