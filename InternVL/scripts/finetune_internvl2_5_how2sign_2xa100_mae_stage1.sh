...
#SBATCH --job-name=internvl25_how2sign_2xa100_mae_stage1
...
# Clear corrupted torch extensions cache
rm -rf /home/mh2803/.cache/torch_extensions/py310_cu121/fused_adam 2>/dev/null || true
if [ -z "${CUDA_HOME:-}" ]; then
...
OUTPUT_DIR="/home/mh2803/projects/sign_language_llm/InternVL/output/how2sign/internvl2_5_2B_2xa100_mae_stage1"
...
deepspeed --num_gpus=$NUM_DEVICES --master_port=$MASTER_PORT \
    ...
    --deepspeed internvl_chat/zero_stage1_config_mae.json \
    --local_rank -1 \
