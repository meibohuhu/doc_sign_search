...
# NOTE the -l flag!
#
# Qwen2VL How2Sign Training on 4xA100 GPUs - ROBUST VERSION
# Using DeepSpeed ZeRO-3 for efficient multi-GPU training
# Includes network timeout handling and offline fallback

#SBATCH --job-name=qwen2vl_how2sign_4xa100_filtered_32batchsize_prompt
...
echo "🚀 Starting Qwen2VL How2Sign Training on 4xA100 (ROBUST VERSION)"
echo "================================================================"
...
deepspeed src/train/train_sft.py \
    ...
    --model_id $MODEL_NAME \
    --data_path /home/mh2803/projects/sign_language_llm/how2sign/video/train_videos/segmented_train_videos_focus_hands_face.json \
    --image_folder /shared/rc/llm-gen-agent/mhu/videos/how2sign_train_segment_clips_stable_224x224/ \
    --output_dir /shared/rc/llm-gen-agent/mhu/qwen2.5vl/1101/qwen2vl_how2sign_4xa100_filtered_32batchsize_prompt/ \
    --num_train_epochs 3 \
