...
#SBATCH --job-name=qwen2vl_how2sign_4xa100_filtered_32batchsize_fast
...
deepspeed src/train/train_sft.py \
    ...
    --output_dir /shared/rc/llm-gen-agent/mhu/qwen2.5vl/qwen2vl_how2sign_4xa100_filtered_32batchsize_fast/ \
    --num_train_epochs 3 \
