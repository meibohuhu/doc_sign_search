...
#SBATCH --job-name=qwen2vl_how2sign_4xa100_filtered_16batchsize
...
deepspeed src/train/train_sft.py \
    ...
    --output_dir /shared/rc/llm-gen-agent/mhu/qwen2.5vl/qwen2vl_how2sign_4xa100_filtered_16batchsize/ \
    --num_train_epochs 3 \
