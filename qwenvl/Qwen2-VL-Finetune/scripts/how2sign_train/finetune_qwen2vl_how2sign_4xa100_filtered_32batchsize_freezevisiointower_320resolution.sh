...
#SBATCH --job-name=qwen2vl_how2sign_4xa100_filtered_32batchsize_freezevisiointower_320resolution
...
deepspeed src/train/train_sft.py \
    ...
    --output_dir /shared/rc/llm-gen-agent/mhu/qwen2.5vl/qwen2vl_how2sign_4xa100_filtered_32batchsize_freezevisiointower_320resolution/ \
    --num_train_epochs 3 \
