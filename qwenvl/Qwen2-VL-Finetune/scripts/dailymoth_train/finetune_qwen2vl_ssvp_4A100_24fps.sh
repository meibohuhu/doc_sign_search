...
#SBATCH --job-name=qwen2vl_ssvp_4xa100_24fps
...
# Updated to use train_ssvp_updated.json with improved ASL translation prompts
deepspeed src/train/train_sft.py \
    --deepspeed scripts/zero3_qwen2vl.json \
    --model_id $MODEL_NAME \
    --data_path /home/mh2803/projects/sign_language_llm/vanshika/asl_test/train_ssvp_updated.json \
    --image_folder /home/mh2803/projects/sign_language_llm/dailymoth-70h/dailymoth-70h/unblurred_clips/videos/ \
    --output_dir /shared/rc/llm-gen-agent/mhu/qwen2.5vl/qwen2vl_ssvp_4xa100_24fps/ \
    --num_train_epochs 3 \
