...
#SBATCH --job-name=qwen2vl_ssvp_2xa100_12fps_diverse_vision_tower
...
deepspeed src/train/train_sft.py \
    ...
    --output_dir /shared/rc/llm-gen-agent/mhu/qwen2.5vl/qwen2vl_ssvp_2xa100_12fps_diverse_vision_tower/ \
    --num_train_epochs 3 \
