...
#SBATCH --job-name=qwen2vl_ssvp_optimized_1xa100
...
# Updated to use train_ssvp_small_1500_updated.json with system message for better ASL translation
torchrun --nproc_per_node=1 --nnodes=1 --master_port=29501 src/train/train_sft.py \
    ...
    --output_dir /home/mh2803/projects/sign_language_llm/qwenvl/Qwen2-VL-Finetune/output/qwen2vl_ssvp_optimized_1xa100 \
    --num_train_epochs 3 \
