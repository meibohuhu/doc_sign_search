...
#SBATCH --job-name=qwen2vl_ssvp_2xa100_12fps_system
...
# Model configuration - using 3B model for faster training
MODEL_NAME="Qwen/Qwen2.5-VL-3B-Instruct"

# Optimized training configuration for 2xA100 GPU
GLOBAL_BATCH_SIZE=8
BATCH_PER_DEVICE=1
NUM_DEVICES=2
...
deepspeed src/train/train_sft.py \
    ...
    --model_id $MODEL_NAME \
    --data_path /home/mh2803/projects/sign_language_llm/vanshika/asl_test/train_ssvp_updated_system.json \
    --image_folder /home/mh2803/projects/sign_language_llm/dailymoth-70h/dailymoth-70h/unblurred_clips/videos/ \
    --output_dir /shared/rc/llm-gen-agent/mhu/qwen2.5vl/qwen2vl_ssvp_2xa100_12fps_system/ \
    --num_train_epochs 3 \
