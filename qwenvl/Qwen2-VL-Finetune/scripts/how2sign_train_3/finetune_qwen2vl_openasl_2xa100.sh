...
# NOTE the -l flag!
#
# Qwen2VL OpenASL Training on 2xA100 GPUs
# Using DeepSpeed ZeRO-3 for efficient multi-GPU training

#SBATCH --job-name=qwen2vl_openasl_2xa100
...
# Optimized training configuration for 2xA100 GPUs (128GB each)
...
echo "🚀 Starting Qwen2VL OpenASL Training on 2xA100"
echo "================================================"
...
deepspeed src/train/train_sft.py \
    ...
    --output_dir /shared/rc/llm-gen-agent/mhu/qwen2.5vl/1126/qwen2vl_openasl_2xa100/ \
    --num_train_epochs 3 \
