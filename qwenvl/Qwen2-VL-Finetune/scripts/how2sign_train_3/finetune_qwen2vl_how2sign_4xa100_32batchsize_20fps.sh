...
#SBATCH --job-name=qwen2vl_how2sign_4xa100_32batchsize_20fps
...
deepspeed src/train/train_sft.py \
    ...
    --output_dir /shared/rc/llm-gen-agent/mhu/qwen2.5vl/1124/qwen2vl_how2sign_4xa100_32batchsize_20fps/ \
    --num_train_epochs 3 \
