...
#SBATCH --job-name=qwen2vl_how2sign_4xa100_filtered_32batchsize_robust
...
deepspeed src/train/train_sft.py \
    ...
    --output_dir /shared/rc/llm-gen-agent/mhu/qwen2.5vl/1018/qwen2vl_how2sign_4xa100_filtered_32batchsize_robust/ \
    --num_train_epochs 3 \
