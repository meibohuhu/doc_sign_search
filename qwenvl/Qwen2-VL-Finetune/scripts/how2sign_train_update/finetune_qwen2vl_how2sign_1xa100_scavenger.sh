...
#SBATCH --job-name=qwen2vl_how2sign_1xa100_scavenger
...
torchrun --nproc_per_node=1 --nnodes=1 --master_port=29501 src/train/train_sft.py \
    ...
    --output_dir /home/mh2803/projects/sign_language_llm/qwenvl/Qwen2-VL-Finetune/output/qwen2vl_how2sign_1xa100_scavenger \
    --num_train_epochs 3 \
