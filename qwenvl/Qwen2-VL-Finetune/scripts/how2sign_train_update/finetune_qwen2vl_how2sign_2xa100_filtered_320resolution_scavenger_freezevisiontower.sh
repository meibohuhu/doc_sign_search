...
#SBATCH --job-name=qwen2vl_how2sign_2xa100_filtered_320resolution_scavenger_freezevisiontower
...
deepspeed src/train/train_sft.py \
    ...
    --output_dir /shared/rc/llm-gen-agent/mhu/qwen2.5vl/1018/qwen2vl_how2sign_2xa100_filtered_320resolution_scavenger_freezevisiontower/ \
    --num_train_epochs 3 \
