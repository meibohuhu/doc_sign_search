...
# NOTE the -l flag!
#
# Qwen2VL How2Sign Training on 2xA100 GPUs - ROBUST VERSION
# Using DeepSpeed ZeRO-3 for efficient multi-GPU training
# Includes network timeout handling and offline fallback

#SBATCH --job-name=qwen2vl_how2sign_2xa100_filtered_320resolution_scavenger
...
GLOBAL_BATCH_SIZE=4  # Reduced from 8 to 4 to prevent OOM
BATCH_PER_DEVICE=1
NUM_DEVICES=2
GRAD_ACCUM_STEPS=$((GLOBAL_BATCH_SIZE / (BATCH_PER_DEVICE * NUM_DEVICES)))

echo "🚀 Starting Qwen2VL How2Sign Training on 2xA100 (ROBUST VERSION)"
echo "==============================================================="
echo "Model: $MODEL_NAME"
echo "Global Batch Size: $GLOBAL_BATCH_SIZE (Memory Optimized)"
...
deepspeed src/train/train_sft.py \
    ...
    --output_dir /shared/rc/llm-gen-agent/mhu/qwen2.5vl/1018/qwen2vl_how2sign_2xa100_filtered_320resolution_scavenger/ \
    --num_train_epochs 3 \
