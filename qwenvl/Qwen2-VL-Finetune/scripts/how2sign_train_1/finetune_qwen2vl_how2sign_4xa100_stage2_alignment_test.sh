...
#SBATCH --job-name=qwen2vl_how2sign_4xa100_stage2_alignment_test
...
deepspeed src/train/train_sft.py \
    ...
    --model_id $MODEL_NAME \
    --data_path /home/mh2803/projects/sign_language_llm/how2sign/video/train_videos/segmented_train_videos_lt20s.json \
