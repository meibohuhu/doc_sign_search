...
#SBATCH --job-name=qwen2vl_how2sign_2xa100_short_clips_recipe_increase
...
deepspeed src/train/train_sft.py \
    ...
    --output_dir /shared/rc/llm-gen-agent/mhu/qwen2.5vl/1018/qwen2vl_how2sign_2xa100_short_clips_recipe_increase/ \
    --num_train_epochs 3 \
