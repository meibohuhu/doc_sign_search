...
OUTPUT_DIR='/genai/fsx-project/zachsun/checkpoint/doc_sign_search/finetune_stage1_broad_h2s_1_open_1_yt_1_global64_lora4_0327'

if [ ! -d "$OUTPUT_DIR" ]; then
  mkdir -p "$OUTPUT_DIR"
fi

# Stage 1: Broad Mixed SFT (OpenASL + H2S + YouTube)
...
srun  \
  ...
  --meta_path "/home/zachsun/doc_sign_search/script_meta/0327/train_stage1_meta_broad_h2s_1_open_1_yt_1.json" \
  ...
  --report_to wandb \
  --run_name "finetune_stage1_broad_h2s_1_open_1_yt_1_global64_lora4_0327" \
  --use_packed_ds False \
