...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/genai/fsx-project/zachsun/checkpoint/doc_sign_search/finetune_stage1_broad_h2s_1_openold_1_yt_037_0321/checkpoint-6906}"
...
srun  \
  ...
  python -u scripts/cluster_eval/internvl_eva_scripts/internvl_evaluation_how2sign_nogate_nogrpo_wandb.py \
    ...
    --wandb-run-name "eval_stage1_broad_h2s_1_openold_1_yt_037_0321_checkpoint-6906" \
