...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/genai/fsx-project/zachsun/checkpoint/doc_sign_search/finetune_stage1_broad_h2s_2_open_1_yt_1_0321/checkpoint-8858}"
...
srun  \
  ...
  python -u scripts/cluster_eval/internvl_eva_scripts/internvl_evaluation_how2sign_nogate_nogrpo_wandb.py \
    ...
    --wandb-run-name "eval_stage1_broad_h2s_2_open_1_yt_1_0321_checkpoint-8858" \
