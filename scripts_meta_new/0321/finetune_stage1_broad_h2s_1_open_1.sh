...
OUTPUT_DIR='/genai/fsx-project/zachsun/checkpoint/doc_sign_search/finetune_stage1_broad_h2s_1_open_1_0321'
...
srun  \
  ...
  --meta_path "/home/zachsun/doc_sign_search/script_meta/0321/train_stage1_meta_broad_h2s_1_open_1.json" \
