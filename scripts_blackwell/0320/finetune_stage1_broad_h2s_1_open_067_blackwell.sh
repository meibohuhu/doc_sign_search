...
OUTPUT_DIR="/scratch/mh2803/checkpoints/sft/testtttt"
META_PATH="/home/stu2/s15/mh2803/workspace/doc_sign_search/scripts_blackwell/0320/train_stage1_meta_broad_h2s_1_open_067_blackwell.json"
# RESUME_CHECKPOINT="${RESUME_CHECKPOINT:-$OUTPUT_DIR/checkpoint-3008}"
...
deepspeed --include localhost:$GPU_IDS --master_port=$MASTER_PORT \
    ...
    --report_to wandb \
    --run_name "stage1_broad_h2s_1_open_067_blackwell" \
