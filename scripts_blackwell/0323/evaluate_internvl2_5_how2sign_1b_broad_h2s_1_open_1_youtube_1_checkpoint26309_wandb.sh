...
# Configuration
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/scratch/mh2803/checkpoints/sft/finetune_stage1_broad_h2s_1_open_1_youtube_1_0319/checkpoint-26309}"
...
OUT_DIR="${OUT_DIR:-/home/stu2/s15/mh2803/workspace/doc_sign_search/outputs/blackwell/finetune_stage1_broad_h2s_1_open_1_youtube_1_0319}"
...
python scripts/cluster_eval/internvl_eva_scripts/internvl_evaluation_how2sign_nogate_nogrpo_wandb.py \
    ...
    --wandb-run-name "finetune_stage1_broad_h2s_1_open_1_youtube_1_0319_checkpoint26309" \
