...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/scratch/mh2803/checkpoints/sft/finetune_stage2_h2s_stage1_broad_h2s_1_open_067_youtube_0_25_checkpoint6225/checkpoint-1019-fixed}"
...
OUT_DIR="${OUT_DIR:-/home/stu2/s15/mh2803/workspace/doc_sign_search/outputs/blackwell/finetune_stage2_broad_h2s_1_open_067_youtube_0_25_0319_checkpoint1019}"
...
python scripts/cluster_eval/internvl_eva_scripts/internvl_evaluation_how2sign_nogate_nogrpo_wandb.py \
    ...
    --wandb-run-name "finetune_stage2_broad_h2s_1_open_067_youtube_0_25_0319_checkpoint1019" \
