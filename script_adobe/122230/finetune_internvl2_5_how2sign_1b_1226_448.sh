...
OUTPUT_DIR="/code/doc_sign_search/script_adobe/checkpoints/finetune_internvl2_5_how2sign_1b_1226_448"
META_PATH="/code/doc_sign_search/script_adobe/train_how2sign_meta.json"
IMAGE_ROOT="/mnt/localssd/doc_sign_search/sign_mllm_how_448_train_val"
...
MAX_SEQ_LENGTH=${MAX_SEQ_LENGTH:-33168}
