...
OUTPUT_DIR="/code/doc_sign_search/script_adobe/checkpoints/finetune_internvl2_5_how2sign_1b_1223_190"
...
NUM_IMAGES_EXPECTED=${NUM_IMAGES_EXPECTED:-190}
MAX_NUM_FRAME=${MAX_NUM_FRAME:-190}
