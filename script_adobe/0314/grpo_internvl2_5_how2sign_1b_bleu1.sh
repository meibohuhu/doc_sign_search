...
export WANDB_RUN_NAME="grpo_1b_bleu1_$(date +%m%d_%H%M)"
...
OUTPUT_DIR="/mnt/localssd/checkpoints/grpo_internvl2_5_how2sign_1b_bleu1"
...
deepspeed --include localhost:$GPU_IDS --master_port=$MASTER_PORT \
    internvl_chat/internvl/train/grpo/internvl_grpo_train_bleu1.py \
