...
export WANDB_RUN_NAME="grpo_1b_bleu1_bleu4_05_05_$(date +%m%d_%H%M)"
...
# ── Model & Data ──
MODEL_PATH="/mnt/localssd/checkpoints/finetune_internvl2_5_how2sign_1b_16fps_1218_121640/checkpoint-2548"
OUTPUT_DIR="/mnt/localssd/checkpoints/grpo_internvl2_5_how2sign_1b_bleu1_bleu4_05_05"
DATA_PATH="/mnt/localssd/workspace/doc_sign_search/InternVL/data/how2sign/segmented_train_val_combined_sampled_10k.jsonl"
VIDEO_ROOT="/mnt/localssd/doc_sign_search/train_crop_videos_224"
...
DEEPSPEED_CONFIG="internvl_chat/zero_stage0_config.json"
...
deepspeed --include localhost:$GPU_IDS --master_port=$MASTER_PORT \
    internvl_chat/internvl/train/grpo/internvl_grpo_train_bleu1_bleu4_05_05.py \
