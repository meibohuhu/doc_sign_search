...
# CUDA_HOME for DeepSpeed ops (conda env has CUDA toolkit)
export CUDA_HOME="$HOME/anaconda3/envs/internvl"

# Use gloo backend for Blackwell GPU (NCCL causes illegal memory access on sm_120)
export DIST_BACKEND=gloo

# NCCL settings (kept for reference, not used with gloo)
...
OUTPUT_DIR="/scratch/mh2803/checkpoints/finetune_internvl2_5_how2sign_1b_unfreeze"
META_PATH="/home/stu2/s15/mh2803/workspace/doc_sign_search/script_adobe/train_how2sign_meta.json"
IMAGE_ROOT="/scratch/mh2803/train_crop_videos_224"
...
# Using Stage 0 config for Blackwell GPU compatibility (no CUDA kernel compilation issues)
