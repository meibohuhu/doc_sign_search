...
export WANDB_RUN_NAME="grpo_1b_bleu1_rouge_alldata_$(date +%m%d_%H%M)"
...
OUTPUT_DIR="/mnt/localssd/checkpoints/grpo_internvl2_5_how2sign_1b_bleu1_rouge_alldata_0315"
DATA_PATH="/mnt/localssd/workspace/doc_sign_search/InternVL/data/how2sign/segmented_train_val_combined.jsonl"
...
deepspeed --include localhost:$GPU_IDS --master_port=$MASTER_PORT \
    internvl_chat/internvl/train/grpo/internvl_grpo_train_bleu1_rouge.py \
