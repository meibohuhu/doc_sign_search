...
OUTPUT_DIR="/code/doc_sign_search/script_adobe/checkpoints/finetune_internvl2_5_how2sign_openasl_1b_1224"
META_PATH="/code/doc_sign_search/script_adobe/train_how2sign_openasl_meta.json"
