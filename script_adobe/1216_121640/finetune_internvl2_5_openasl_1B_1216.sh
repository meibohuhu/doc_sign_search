#!/bin/bash
#
# InternVL2.5-1B OpenASL Fine-Tuning on 4*A100
...
OUTPUT_DIR="/code/doc_sign_search/script_adobe/checkpoints/finetune_internvl2_5_openasl_1B_1216"
...
echo "🚀 Starting InternVL2.5-1B OpenASL Training on 4*A100"
echo "======================================================"
