...
MODEL_NAME="/mnt/localssd/checkpoints/sft/finetune_stage1_broad_h2s_1_open_1_youtube_1_0319/checkpoint-19731"
OUTPUT_DIR="/mnt/localssd/checkpoints/sft/finetune_stage2_broad_h2s_1_open_1_youtube_1_checkpoint19731"
...
deepspeed --include localhost:$GPU_IDS --master_port=$MASTER_PORT \
    ...
    --report_to wandb \
    --run_name "finetune_stage2_broad_h2s_1_open_1_youtube_1_checkpoint19731" \
