#!/bin/bash
#
# qwen2.5-vl OpenASL Fine-Tuning on 4*A100
# Set up conda environment - matches setup_qwen2vl_auto.txt
# Anaconda is installed at $HOME/anaconda3 by setup script
# Environment name: qwen2vl
# Initialize and activate conda environment
# source "$HOME/anaconda3/etc/profile.d/conda.sh"
# conda activate qwen2vl
# echo "✅ Conda environment activated: qwen2vl"
...
OUTPUT_DIR="/code/doc_sign_search/script_adobe/checkpoints/finetune_qwen2_5_7b"
DATA_PATH="/code/doc_sign_search/how2sign/video/segmented_train_val_combined.json"
