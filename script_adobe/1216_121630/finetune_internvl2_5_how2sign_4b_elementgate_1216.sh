#!/bin/bash
#
# InternVL2.5-4B How2Sign Fine-Tuning on 4*A100
...
OUTPUT_DIR="/code/doc_sign_search/script_adobe/checkpoints/finetune_internvl2_5_how2sign_4b_elementgate_1216"
...
echo "🚀 Starting InternVL2.5-4B How2Sign Training on 4*A100"
echo "======================================================"
