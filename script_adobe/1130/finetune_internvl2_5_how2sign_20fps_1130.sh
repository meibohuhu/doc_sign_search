...
OUTPUT_DIR="/code/doc_sign_search/script_adobe/checkpoints/finetune_internvl2_5_how2sign_20fps_1130"
...
NUM_IMAGES_EXPECTED=${NUM_IMAGES_EXPECTED:-192}
MAX_NUM_FRAME=${MAX_NUM_FRAME:-192}
